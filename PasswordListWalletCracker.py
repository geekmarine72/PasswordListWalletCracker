...
print("\nAttempting to crack wallet password")
...
def attemptdecrypt( wallet, password ):
    clear = decrypt(wallet, password)
    try:
...
for line in iter(pfile):
    print("Attempting password: " + line)
    password = line
    result = attemptdecrypt(wallet,password)
pfile.close()